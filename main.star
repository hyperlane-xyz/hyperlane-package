...
prometheus = import_module("github.com/kurtosis-tech/prometheus-package")
grafana = import_module("github.com/kurtosis-tech/grafana-package")
...
def run(
    ...
    validator_metrics_job = {
        ...
        "Endpoint": "http://{0}:{1}".format(validator.ip_address, validator.ports["metrics"].number),
        "Labels": {},
    }
