...
def run(
        ...
        relay_chains,
        rpc_urls={},
        custom_validator_image="gcr.io/abacus-labs-dev/hyperlane-agent:3b1b8dc-20231115-202111",
        custom_relayer_image="gcr.io/abacus-labs-dev/hyperlane-agent:3b1b8dc-20231115-202111",
        log_level="info",
        aws_access_key_id="",
